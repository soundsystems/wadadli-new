...
const OrderNowButton = (props: Props) => {
  return (
    ...
    <button className="group relative flex items-center divide-x divide-orange-500 rounded-xl bg-zinc-50/60 py-1 px-2 leading-none shadow-lg shadow-zinc-900/75 transition duration-300 hover:divide-orange-200 hover:bg-zinc-900/90 hover:shadow-md">
      <span className="pr-2">
      <TruckIcon className="h-8 w-8 text-orange-500 transition duration-300 group-hover:text-orange-100" />
      </span>
      <span className="pl-2 text-lg font-semibold uppercase text-orange-500 transition duration-300 group-hover:text-orange-100 md:inline-flex lg:text-lg">
        &larr; Order Now
      </span>
    </button>
  </Link>
